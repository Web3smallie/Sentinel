...
*/
var DESAlgo = class extends require_cipher_core.BlockCipher {
...
*/
const DES = require_cipher_core.BlockCipher._createHelper(DESAlgo);
/**
* Triple-DES block cipher algorithm.
*/
var TripleDESAlgo = class extends require_cipher_core.BlockCipher {
	/** Key size in 32-bit words */
	...
	_doReset() {
		...
		this._des1 = DESAlgo.createEncryptor(require_core.WordArray.create(key1));
		this._des2 = DESAlgo.createEncryptor(require_core.WordArray.create(key2));
		this._des3 = DESAlgo.createEncryptor(require_core.WordArray.create(key3));
	}
	encryptBlock(M, offset) {
...
*/
const TripleDES = require_cipher_core.BlockCipher._createHelper(TripleDESAlgo);
